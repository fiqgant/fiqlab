    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my work, article, etc. I am a geek who is passionate about Machine Learning and Artificial Intelligence."
          />
