...
**Learning roadmap in the WBI format.** This one groups the Sub-CPMK that already exist into *modules* spanning ranges of sessions, then builds a WBI-style Excel roadmap: Output / Concept / Indicators / Learning Strategy per module, UTS and UAS as their own columns, a distinct pastel colour per module. Two guardrails: it only runs *after* the Sub-CPMK exist — no roadmap built on invented outcomes — and the module grouping is interpretive, so the skill proposes a grouping and waits for confirmation before generating the file.
...
- **Updating a skill is an iterative process, not a one-shot design.** Version 5.9.0 came from a real problem with the order lecturer research got asked for; version 5.10.0 came from a complaint about messy files when using Cowork; version 5.13.0 came from noticing the skill only covered the front half of the OBE cycle and never the end-of-semester evaluation that closes it. A good skill is the product of repeated real use, not something perfectly designed up front.
...
If you're a lecturer or from another department who wants to try this, the skill file (`akademik-dosen-obe-fiq`, v5.13.0) is available for download here:

**[Download OBE Fiq Skill v5.13.0 (.skill)](https://github.com/fiqgant/fiqlab/releases/download/obe-fiq-skill-v5.13.0/akademik-dosen-obe-fiq-v5.13.0.skill)**
...
![QR code to download the Akademik Dosen OBE Fiq skill](/images/blog/akademik-dosen-obe-fiq-qr.png)
