...
<div className="grid place-items-center">
  <img
    className="inline rounded-lg"
    src="https://wallpaper.dog/large/20459347.jpg"
    alt="AI"
    width="1920"
    height="1080"
  />
...
We would prefer to discourage the use of AI as a countable term when discussing it: one AI, two AIs, and so on. AI, like mathematics or biology, is a scientific discipline. This indicates that AI is a collection of concepts, challenges, and solutions.
Because AI is a science, you should not refer to it as "an AI," just as we should not refer to biology as "a biology." This should be obvious when you say something like "we need more artificial intelligences." That just doesn't seem right, does it? (It certainly does for me.)
