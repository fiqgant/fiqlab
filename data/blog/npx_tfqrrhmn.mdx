...
# Introduction
I was browsing GitHub the other day when I came across [Anmol Singh](https://github.com/anmol098/npx_card)'s brilliant idea of designing a npx card to identify themselves. I thought it was a great idea, so I created one for myself as well!
...
Let's create a new JavaScript object with our prompt questions. This is a sample from my `card.js` you can add or edit whatever you want
