      ...
      <div className='flex flex-col-reverse gap-8 md:flex-row md:justify-between'>
        ...
        >
          <h1 className='font-title bg-gradient-to-b from-black via-black/90 to-black/70 to-90% bg-clip-text text-2xl font-bold leading-9 text-transparent sm:text-4xl sm:leading-[3.5rem] dark:from-white dark:via-white/90 dark:to-white/70'>
            I'm Taufiqurrahman, a Researcher passionate about{' '}
          ...
          <div className='text-muted-foreground text-sm'>Medan, Indonesia • UTC/GMT +7</div>
        </motion.div>
        <motion.div
        ...
        >
          <BlurImage
            ...
            lazy={false}
          />
          <div className='absolute inset-0 -z-10 bg-gradient-to-tl from-blue-700 to-green-700 opacity-0 blur-2xl md:opacity-50' />
        </motion.div>
      </div>
    </div>
  )
